...
from models.QueryQTR.ops import get_sinusoid_encoding_table, CorssAttnBlock
from models.QueryQTR.VIT import *
from models.QueryQTR.QEM import QueryExpansionModule
from models.QueryQTR.PSM import PatchSmoothingModule

class TransGen(nn.Module):
    def __init__(self, enc_ckpt_path='/mnt/disk10T/liuxiaoyu/image_crop/QueryOTR-main/checkpoints/pretrain_mae_vit_base_mask_0.75_400e.pth'):
